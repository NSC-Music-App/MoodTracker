...
export interface ApiAiResponseAiResponse extends Struct.CollectionTypeSchema {
  collectionName: 'ai_responses';
  info: {
    displayName: 'AI_response';
    pluralName: 'ai-responses';
    singularName: 'ai-response';
  };
  options: {
...
export interface ApiMoodMood extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ai_response: Schema.Attribute.Relation<
      'oneToOne',
      'api::ai-response.ai-response'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    emoji: Schema.Attribute.Enumeration<
      [
        'Happy',
        'Relaxed',
        'Neutral',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ai-response.ai-response': ApiAiResponseAiResponse;
